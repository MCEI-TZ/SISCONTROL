...
class DepartamentosController {
    constructor(departamentoRepository, logRepository) {
        ...
        this.getDepartamentos = (req, res) => {
            try {
                ...
                new domain_1.GetDepartamentos(this.departamentoRepository)
        ...
        this.getDepartamento = (req, res) => {
            const id = +req.params.id;
            new domain_1.GetDepartamento(this.departamentoRepository)
                .execute(id)
